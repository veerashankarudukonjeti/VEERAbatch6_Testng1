package testcase;
	...
	public class testcase extends Base {
		...
		private void bookAHotel() {
			driver.findElement(By.id("first_name")).sendKeys("9908961746");
			driver.findElement(By.name("last_name")).sendKeys("v");
			driver.findElement(By.xpath(".//textarea[@rows='4']")).sendKeys("veer");
			driver.findElement(By.xpath(".//input[@id='cc_num']")).sendKeys("990897765463");
